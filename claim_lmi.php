...
<body class="bg-custom-img">
    ...
    <section class="container mt-5">
        ...
        <h1 class="text-center text-light my-5">Claim your Livestock Mortality Insurance</h1>
        <?php if ($row['lmi_claim_stat'] != "Approved") { ?>
            <div class="container bg-light rounded-top-5 p-4 text-dark shadow d-md-flex align-item-center justify-content-between">
                <div class="row">
                    ...
                    <div class="col-md-7 mx-5">
                        <p class="lead">
                            To submit your application to claim the insurance, please follow these steps:
                        <ol>
                            <li class="lead">Download the provided claim form. (<a href="forms/notice_of_death_lmi.docx" download>Livestock Mortality Insurance Claim Form</a>) </li>
        ...
        <div class="container bg-light rouded-4 p-5 mb-5 text-dark rounded-bottom-5 shadow">
            ...
            <?php } else { ?>
                <div class="text-center">
                    <h1>Your claim is either under checking or you have not yet applied</h1>
                </div>
            <?php } ?>
            <?php
