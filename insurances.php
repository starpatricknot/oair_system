...
<body class="bg-custom-img">
    ...
    <section class="container my-5">
        <div class="container">
            <h3 class="card-title text-center display-4 p-3 fw-semibold hidden text-light" id="recomm">List of Policies</h3>
            ...
            <div class="animate-delay row row-cols-1 row-cols-md-3 g-5 my-4">
                <div class="col animate-delay hidden animate__animated animate__fadeInLeft animate__delay-1s animate__faster">
                    <div class="card p-3 h-100 rounded-4 shadow-4" id="card-based">
                        <div class="card-body">
                            <h5 class="card-title fs-3 text-center fw-normal my-4">Crop <br> Insurance</h5>
                            ...
                            <div class="text-center">
                                <a href="apply_ci.php" class="btn btn-outline-primary getstarted rounded-4 my-3">Apply Now</a>
                            </div>

                        </div>
                    </div>
                </div>
                <div class="col animate-delay hidden animate__animated animate__fadeInLeft animate__delay-2s animate__faster">
                    <div class="card p-3 h-100 rounded-4 shadow-4" id="card-based">
                        <div class="card-body text">
                            <h5 class="card-title fs-3 text-center fw-normal my-4 based">High Value Crop Insurance</h5>
                            ...
                            <div class="text-center">
                                <a href="apply_hvci.php" class="btn btn-outline-primary getstarted rounded-4 my-3">Apply Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col animate-delay hidden animate__animated animate__fadeInLeft animate__delay-3s animate__faster">
                    <div class="card p-3 h-100 rounded-4 shadow-4" id="card-based">
                        <div class="card-body">
                            <h5 class="card-title fs-3 text-center fw-normal my-4">Livestock Mortality Insurance</h5>
                            ...
                            <div class="text-center">
                                <a href="apply_lmi.php" class="btn btn-outline-primary getstarted rounded-4 my-3">Apply Now</a>
                            </div>
