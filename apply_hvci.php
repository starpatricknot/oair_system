...
<body class="bg-custom-img">
    ...
    <section class="container mt-5">
        ...
        <h1 class="text-center text-light my-5">High Quality Crop Insurance Application</h1>
        <?php if ($row['hvci_form'] == NULL) { ?>
            <div class="container bg-light rounded-top-5 p-4 text-dark shadow d-md-flex align-item-center justify-content-between">
                <div class="row">
                    ...
                    <div class="col-md-7 mx-5">
                        ...
                        <ol>
                            <li class="lead">Download the provided application form. (<a href="forms/hvci_application_form.docx" download>High Quality Crop Insurance Form</a>) </li>
