...
<body class="bg-custom-img">
    ...
    <section class="container mt-5">
        ...
        <h1 class="text-center text-light my-5">Claim Your Crop Insurance</h1>
            ...
            <div class="container bg-light rounded-top-5 p-4 text-dark shadow d-md-flex align-item-center justify-content-between">
                <div class="row">
                    ...
                    <div class="col-md-7 mx-5">
                        ...
                        <ol>
                            <li class="lead">Download the provided claim form. (<a href="forms/notice_of_loss_crop.docx" download>Crop Insurance Claim Form</a>) </li>
            ...
            <?php if ($row['lmi_claim_stat'] != "Approved") { ?>
                <form method="POST" action="#" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="date" value="<?php echo $today; ?>" class="form-control" id="date" name="ci_claim_date" hidden>
                    </div>
