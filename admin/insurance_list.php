...
<body class="">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary card-header-icon">
                                    ...
                                    <h4 class="card-title">User Insurance Application Status</h4>
                                </div>
                                <div class="card-body">
                                    <div class="toolbar">
                                        ...
                                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Name</th>
                                                    <th>Email</th>
                                                    <th>CI Application</th>
                                                    <th>HVCI Application</th>
                                                    <th>LMI Application</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($query as $q) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo empty($q['ci_status']) ? 'Not Applied' : $q['ci_status']; ?></td>
                                                        <td><?php echo empty($q['hvci_status']) ? 'Not Applied' : $q['hvci_status']; ?></td>
                                                        <td><?php echo empty($q['lmi_status']) ? 'Not Applied' : $q['lmi_status']; ?></td>
                                                        <td class="text-right">
    ...
    <script>
        var data = {
            labels: ['Apple', 'Windows Phone ', 'Samsung'],
            series: [20, 15, 40]
        };
