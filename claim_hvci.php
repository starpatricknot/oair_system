...
<body class="bg-custom-img">
    ...
    <section class="container mt-5">
        ...
        <h1 class="text-center text-light my-5">Claim your High Quality Crop Insurance</h1>
        <?php if ($row['hvci_claim_stat'] != "Approved") { ?>
            <div class="container bg-light rounded-top-5 p-4 text-dark shadow d-md-flex align-item-center justify-content-between">
                <div class="row">
                    ...
                    <div class="col-md-7 mx-5">
                        ...
                        <ol>
                            <li class="lead">Download the provided claim form. (<a href="forms/notice_of_loss_hvcc.docx" download>High Quality Crop Insurance Claim Form</a>) </li>
